...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-1x7qd&*ywi4gaq12i)!h%uakojcji8y@=_$(ji9hpkt5x96efm6')
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = "main"  # Route defined in home/urls.py
